    ...
    digitarOpcao = (opcao) => {
        if (this.state.ligado || !this.state.erro) {
            switch (opcao) {
                ...
                case '9':
                case ',':
                    console.log('Eh um numero', opcao)
                    break;
                case 'x':
                case '÷':
                case '+':
                case '-':
                    console.log('Eh um operador', opcao)
                    break;
                case '=':
                    console.log('Eh o resultado', opcao)
                    break;
                case 'CE':
                case 'C':
                    console.log('Reseta tudo', opcao)
                    break;
                default:
            ...
            <section className="calculadora">
                ...
                <p className={this.state.ligado ? 'display active' : 'display'}>{this.state.display}</p>
                    ...
                    <div className='row'>
                        ...
                        <Button buttonText="x" acao={this.digitarOpcao} className = "btn-primary" />
